...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
        ...
        AbstractMapProvider mprovider = new Microsoft.AerialProvider();
		// Set a zoom level
		int zoomLevel = 10;
		...
		map2 = new UnfoldingMap(this, 400, 50, 350, 500, mprovider);

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map1.zoomAndPanTo(zoomLevel, new Location(-22.9f, -43.2f));
